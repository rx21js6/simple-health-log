...
CREATE TABLE IF NOT EXISTS public.key_iv (
    id integer NOT NULL,
    encryption_key text,
    encryption_iv text,
    created_by integer,
...
CREATE TABLE IF NOT EXISTS public.physical_condition (
    id integer NOT NULL,
...
ALTER TABLE public.key_iv DROP CONSTRAINT IF EXISTS key_iv_pkey;
...
ALTER TABLE public.physical_condition DROP CONSTRAINT IF EXISTS physical_condition_pkey CASCADE;
...
ALTER TABLE public.user_info DROP CONSTRAINT IF EXISTS user_info_pkey CASCADE;
...
ALTER TABLE public.user_token DROP CONSTRAINT IF EXISTS user_token_pkey;
...
ALTER TABLE public.physical_condition DROP CONSTRAINT IF EXISTS physical_condition_id_fkey;
ALTER TABLE ONLY public.physical_condition
...
ALTER TABLE public.user_token DROP CONSTRAINT IF EXISTS user_token_id_fkey;
ALTER TABLE ONLY public.user_token
